...
const calculatePM25_AQI = (pm25) => {
  ...
  if (c >= 0 && c <= 12.0) { IHigh = 50; ILow = 0; CHigh = 12.0; CLow = 0.0; }
  else if (c >= 12.1 && c <= 35.4) { IHigh = 100; ILow = 51; CHigh = 35.4; CLow = 12.1; }
  else if (c >= 35.5 && c <= 55.4) { IHigh = 150; ILow = 101; CHigh = 55.4; CLow = 35.5; }
  else if (c >= 55.5 && c <= 150.4) { IHigh = 200; ILow = 151; CHigh = 150.4; CLow = 55.5; }
  else if (c >= 150.5 && c <= 250.4) { IHigh = 300; ILow = 201; CHigh = 250.4; CLow = 150.5; }
  else if (c >= 250.5 && c <= 350.4) { IHigh = 400; ILow = 301; CHigh = 350.4; CLow = 250.5; }
  else if (c >= 350.5 && c <= 500.4) { IHigh = 500; ILow = 401; CHigh = 500.4; CLow = 350.5; }
  else { return 500; } // Beyond index
...
const calculatePM10_AQI = (pm10) => {
  ...
  if (c >= 0 && c <= 54) { IHigh = 50; ILow = 0; CHigh = 54; CLow = 0; }
  else if (c >= 55 && c <= 154) { IHigh = 100; ILow = 51; CHigh = 154; CLow = 55; }
  else if (c >= 155 && c <= 254) { IHigh = 150; ILow = 101; CHigh = 254; CLow = 155; }
  else if (c >= 255 && c <= 354) { IHigh = 200; ILow = 151; CHigh = 354; CLow = 255; }
  else if (c >= 355 && c <= 424) { IHigh = 300; ILow = 201; CHigh = 424; CLow = 355; }
  else if (c >= 425 && c <= 504) { IHigh = 400; ILow = 301; CHigh = 504; CLow = 425; }
  else if (c >= 505 && c <= 604) { IHigh = 500; ILow = 401; CHigh = 604; CLow = 505; }
  else { return 500; }
