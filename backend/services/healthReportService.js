...
export const analyzeMedicalImages = async (imageUrls) => {
  ...
  try {
    ...
    const contentBlocks = [
      {
        type: 'text',
        text: 'You are a medical data extraction assistant. Analyze these medical reports/images. Extract relevant health conditions, medications, abnormal values, and doctor notes. Return ONLY a concise text summary of the findings. Do NOT give medical advice.',
      },
    ];
