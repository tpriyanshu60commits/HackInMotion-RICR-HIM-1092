...
const GlassCard = ({ children, className = '' }) => (
  <div className={`bg-white/[0.06] backdrop-blur-[16px] border border-white/[0.12] rounded-[20px] shadow-lg ${className}`}>
    {children}
  </div>
);
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0F0D] text-white font-sans selection:bg-green-500/30 overflow-x-hidden">
      ...
      <nav className="fixed top-6 left-0 right-0 z-50 px-4 flex justify-center">
        <div className="w-full max-w-7xl flex items-center justify-between px-6 py-4 bg-[#0A0F0D]/70 backdrop-blur-xl border border-white/10 rounded-full shadow-lg">
          <div className="flex items-center gap-2">
            <svg className="w-6 h-6 text-green-500" fill="currentColor" viewBox="0 0 24 24"><path d="M12 3c-1.1 0-2.1.3-3 .8C7.1 2.9 5.2 2 3 2c0 2 0 4 .8 5.9C3.3 8.8 3 9.9 3 11c0 4.4 3.6 8 8 8s8-3.6 8-8c0-1.1-.3-2.2-.8-3.1.8-1.9.8-3.9.8-5.9-2.2 0-4.1.9-6 1.8-.9-.5-1.9-.8-3-.8zm0 14c-3.3 0-6-2.7-6-6 0-1 .3-1.9.8-2.7C7.6 7.7 8.7 7 10 7c1.7 0 3.2 1 3.8 2.5.2.5.2 1.1.2 1.5 0 3.3-2.7 6-6 6z" /></svg>
          ...
          <div className="flex items-center gap-3">
            <Link to="/login" className="hidden sm:block px-5 py-2 text-sm font-medium text-white border border-white/20 rounded-full hover:bg-white/10 transition-colors">
              Log In
            </Link>
            <Link to="/register" className="px-5 py-2 text-sm font-medium bg-green-500 text-white rounded-full hover:bg-green-600 transition-colors">
              Get Started
            </Link>
          </div>
        </div>
      ...
      {/* SECTION 2 - Hero */}
      <section id="home" className="relative z-10 min-h-screen pt-32 pb-12 flex flex-col justify-between">
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 flex-grow items-center">
          ...
          <div className="flex flex-col justify-center max-w-2xl">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <Link to="/register" className="px-8 py-3.5 bg-green-500 text-white rounded-full font-medium hover:bg-green-600 transition-colors">
                Get Started
              </Link>
              <Link to="/dashboard" className="px-8 py-3.5 bg-transparent border border-white/20 text-white rounded-full font-medium hover:bg-white/10 transition-colors">
                Explore Dashboard
              </Link>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 w-full max-w-md mx-auto lg:ml-auto">
            ...
            <GlassCard className="p-6">
              <div className="flex justify-between items-start mb-6">
                <span className="text-xs font-semibold text-gray-400 tracking-wider">AIR QUALITY INDEX:</span>
            ...
            <div className="grid grid-cols-2 gap-4">
              <GlassCard className="p-4">
                <div className="flex justify-between mb-2">
                  ...
                  <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z"></path></svg>
                </div>
              ...
              <GlassCard className="p-4">
                <div className="flex justify-between mb-2">
                  ...
                  <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                </div>
                <div className="flex items-baseline gap-1 mb-2">
              ...
              <GlassCard className="p-4">
                <div className="flex justify-between mb-2">
                  ...
                  <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 3c-1.2 1.6-3 4-3 6a3 3 0 006 0c0-2-1.8-4.4-3-6z"></path></svg>
                </div>
                <div className="mb-2">
        ...
        <div className="relative z-20 w-full px-6 mt-16">
          <GlassCard className="max-w-7xl mx-auto w-full p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { icon: "M13 10V3L4 14h7v7l9-11h-7z", title: "Real-time Data", desc: "Live air quality, weather and environmental updates" },
                { icon: "M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z", title: "Smart Insights", desc: "AI-driven analysis and personalized recommendations" },
                { icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z", title: "Community Driven", desc: "Connect, share and make an impact" },
                { icon: "M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z", title: "Sustainable Future", desc: "Together we build a better tomorrow" }
              ].map((ft, idx) => (
                <div key={idx} className="flex gap-4 items-start">
                  <div className="w-10 h-10 rounded-full bg-green-500/10 flex items-center justify-center shrink-0 border border-green-500/20">
                    <svg className="w-5 h-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d={ft.icon} />
                    </svg>
                  </div>
                  <div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative group">
            ...
            <div className="mt-6 flex items-center gap-3 px-4">
              ...
              <p className="text-sm text-gray-400 font-medium">Together, we can create a cleaner, greener planet for generations to come.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="relative z-10 py-24 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: "Real-time Air Quality Monitoring", desc: "Get live AQI updates, pollutant levels and weather conditions anywhere, anytime.", icon: "M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z" },
              { title: "Personalized Risk Assessment", desc: "AI-powered risk scores based on your location, health and daily activities.", icon: "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" },
              { title: "Route Risk Analyzer", desc: "Find the safest and healthiest routes for your daily commute with our smart analyzer.", icon: "M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" },
              { title: "Historical Trends", desc: "Track air quality and weather trends with interactive charts and reports.", icon: "M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z" },
              { title: "Community Reports", desc: "Share local environmental issues and stay informed with real-time community contributions.", icon: "M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994 1.994 0 01-1.414-.586m0 0L11 14h4a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2v4l.586-.586z" },
              { title: "AI Assistant", desc: "Ask questions, get insights and receive personalized environmental guidance.", icon: "M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" },
              { title: "Alerts & Notifications", desc: "Get timely alerts for pollution spikes, severe weather and health advisories.", icon: "M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" },
              { title: "Educational Resources", desc: "Learn about sustainability, pollution, health and how you can make a difference.", icon: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" },
            ].map((feature, i) => (
      ...
      <section id="solutions" className="relative z-10 py-24 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start gap-12 lg:gap-4 relative">
            ...
            {[
              { step: 1, title: "Collect Data", desc: "We collect real-time data from trusted environmental sources and community reports.", icon: "M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z" },
              { step: 2, title: "Analyze with AI", desc: "Advanced AI models analyze the data to generate accurate insights and risk scores.", icon: "M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z" },
              { step: 3, title: "Deliver Insights", desc: "Personalized insights, alerts and recommendations delivered to you instantly.", icon: "M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" },
              { step: 4, title: "Take Action", desc: "Stay informed, make better choices and contribute to a healthier planet.", icon: "M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" },
            ].map((item, idx) => (
              <div key={idx} className="relative z-10 flex flex-col items-center max-w-[240px] group">
                ...
                <div className="flex items-center gap-2 mb-3">
                  <span className="w-6 h-6 rounded-full bg-green-500 text-[#0A0F0D] text-xs font-bold flex items-center justify-center shrink-0">{item.step}</span>
          ...
          <GlassCard className="p-10 md:p-16 flex flex-col lg:flex-row items-center justify-between gap-10 relative overflow-hidden">
            ...
            <div className="max-w-2xl relative z-10 text-center lg:text-left">
              ...
              <p className="text-gray-300 text-lg">
                Join thousands of people who are using VerdantX to breathe better, live healthier and build a sustainable future.
              </p>
            </div>
            <div className="flex flex-col sm:flex-row items-center gap-4 relative z-10">
              <Link to="/register" className="w-full sm:w-auto px-8 py-3.5 bg-green-500 text-white rounded-full font-medium hover:bg-green-600 transition-colors whitespace-nowrap text-center">
                Get Started Now
              </Link>
              <Link to="/dashboard" className="w-full sm:w-auto px-8 py-3.5 bg-transparent border border-white/20 text-white rounded-full font-medium hover:bg-white/10 transition-colors whitespace-nowrap backdrop-blur-md text-center">
                Explore Dashboard
              </Link>
            </div>
          </GlassCard>
      ...
      {/* SECTION 7 - Footer */}
      <footer className="relative z-10 bg-[#050806]/60 backdrop-blur-lg pt-20 pb-8 px-6 border-t border-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
            ...
            <div className="lg:col-span-1">
              <div className="flex items-center gap-2 mb-4">
                <svg className="w-6 h-6 text-green-500" fill="currentColor" viewBox="0 0 24 24"><path d="M12 3c-1.1 0-2.1.3-3 .8C7.1 2.9 5.2 2 3 2c0 2 0 4 .8 5.9C3.3 8.8 3 9.9 3 11c0 4.4 3.6 8 8 8s8-3.6 8-8c0-1.1-.3-2.2-.8-3.1.8-1.9.8-3.9.8-5.9-2.2 0-4.1.9-6 1.8-.9-.5-1.9-.8-3-.8zm0 14c-3.3 0-6-2.7-6-6 0-1 .3-1.9.8-2.7C7.6 7.7 8.7 7 10 7c1.7 0 3.2 1 3.8 2.5.2.5.2 1.1.2 1.5 0 3.3-2.7 6-6 6z" /></svg>
                <div className="flex flex-col">
                  <span className="font-bold text-xl leading-none text-white">VerdantX</span>
                  <span className="text-[10px] text-gray-400 mt-1">Breathe Better. Live Better.</span>
                </div>
              </div>
              <p className="text-gray-400 text-sm mb-6 leading-relaxed">
                Empowering individuals and communities with environmental intelligence for a sustainable future.
              </p>
              <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-gray-400">
                {['Features', 'Solutions', 'Air Quality Map', 'Risk Analyzer', 'AI Assistant'].map(link => (
                  <li key={link}><a href="#" className="hover:text-green-500 transition-colors">{link}</a></li>
                ))}
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-gray-400">
                {['Blog', 'Education', 'Reports', 'Guides', 'FAQs'].map(link => (
                  <li key={link}><a href="#" className="hover:text-green-500 transition-colors">{link}</a></li>
                ))}
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-gray-400">
                {['Community Reports', 'Leaderboard', 'Events', 'Discussions', 'Volunteer'].map(link => (
                  <li key={link}><a href="#" className="hover:text-green-500 transition-colors">{link}</a></li>
                ))}
              </ul>
            </div>
          ...
          <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-gray-500">© 2024 VerdantX. All rights reserved.</p>
            <p className="text-sm text-gray-500 flex items-center gap-1">
              Made with <span className="text-red-500">❤</span> for a greener planet <span className="text-green-500">🌱</span>
            </p>
          </div>
        </div>
      </footer>
