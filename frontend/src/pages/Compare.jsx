...
export const Compare = () => {
  ...
  return (
    <div className="min-h-full relative px-2 lg:px-4 py-8 animate-fade-in flex flex-col items-center justify-start">
            ...
            comparisonCities.map((data, idx) => {
              if (data.error) {
                return (
                  <div
                    key={idx}
                    className="flex-1 bg-white/[0.025] backdrop-blur-sm border border-red-500/20 rounded-xl p-7 md:p-8 flex flex-col items-center justify-center"
                  >
