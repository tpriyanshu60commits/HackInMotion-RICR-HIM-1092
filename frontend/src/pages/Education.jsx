          ...
          <div className="space-y-6">
            <div className="border-l-4 border-rose-500 pl-4">
              ...
              <p className="text-text-muted mt-1 leading-relaxed">
                Tiny particles or droplets in the air that are two and one half microns or less in
                width. They are small enough to travel deeply into the respiratory tract, reaching
                the lungs.
              </p>
            </div>
            ...
            <div className="border-l-4 border-amber-500 pl-4">
              ...
              <p className="text-text-muted mt-1 leading-relaxed">
                ...
                Often consists of dust, pollen, and mold.
              </p>
            </div>
            ...
            <div className="border-l-4 border-indigo-500 pl-4">
              ...
              <p className="text-text-muted mt-1 leading-relaxed">
                A colorless, odorless gas that can be harmful when inhaled in large amounts. CO is
                released when something is burned, primarily from vehicles and machinery.
              </p>
            </div>
            ...
            <div className="border-l-4 border-blue-500 pl-4">
              ...
              <p className="text-text-muted mt-1 leading-relaxed">
                Not emitted directly into the air, but created by chemical reactions between oxides
                of nitrogen (NOx) and volatile organic compounds (VOC) in the presence of sunlight.
              </p>
            </div>
          </div>
        </GlassCard>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-surface/50 p-4 rounded-xl border border-border">
              ...
              <p className="text-sm text-text-muted">
                Capturing the sun's energy and converting it into electricity. It's a completely
                renewable resource that heavily reduces greenhouse gas emissions.
              </p>
            </div>
            ...
            <div className="bg-surface/50 p-4 rounded-xl border border-border">
              ...
              <p className="text-sm text-text-muted">
                Using wind turbines to generate mechanical power or electricity. Offshore wind farms
                are becoming a major source of clean energy globally.
              </p>
            </div>
            ...
            <div className="bg-surface/50 p-4 rounded-xl border border-border">
              ...
              <p className="text-sm text-text-muted">
                Replacing internal combustion engines with electric vehicles (EVs) significantly
                lowers local air pollution, especially PM2.5 and CO.
              </p>
            </div>
            ...
            <div className="bg-surface/50 p-4 rounded-xl border border-border">
              ...
              <p className="text-sm text-text-muted">
                Smart irrigation and wastewater recycling technologies are crucial for adapting to
                drought conditions caused by climate change.
              </p>
            </div>
          </div>
        </GlassCard>
              ...
              <tbody>
                <tr className="border-b border-border hover:bg-surface-hover/50 transition-colors">
                  ...
                  <td className="py-3 px-4 text-text-muted text-sm">
                    Enjoy outdoor activities. Air quality is considered satisfactory.
                  </td>
                </tr>
                <tr className="border-b border-border hover:bg-surface-hover/50 transition-colors">
                ...
                <tr className="border-b border-border hover:bg-surface-hover/50 transition-colors">
                  ...
                  <td className="py-3 px-4 text-text-muted text-sm">
                    Everyone may begin to experience health effects. Wear a mask (N95) if going
                    outside.
                  </td>
                </tr>
                <tr className="hover:bg-surface-hover/50 transition-colors">
                  ...
                  <td className="py-3 px-4 text-text-muted text-sm">
                    Health warnings of emergency conditions. Everyone should avoid all outdoor
                    physical activities.
                  </td>
                </tr>
              </tbody>
