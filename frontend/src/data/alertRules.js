...
export const alertRules = [
  ...
  },
  {
    ...
    condition: (prev, curr) =>
      prev &&
      prev.weatherCondition !== 'rain' &&
      prev.weatherCondition !== 'thunderstorm' &&
      (curr.weatherCondition === 'rain' || curr.weatherCondition === 'thunderstorm'),
    messages: {
  ...
  },
  {
    ...
    condition: (prev, curr) =>
      prev &&
      (prev.weatherCondition === 'rain' || prev.weatherCondition === 'thunderstorm') &&
      curr.weatherCondition !== 'rain' &&
      curr.weatherCondition !== 'thunderstorm',
    messages: {
