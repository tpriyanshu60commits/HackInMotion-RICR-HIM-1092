    ...
    return (
      <div className="w-full bg-white/[0.035] backdrop-blur-xl border border-white/[0.10] rounded-2xl p-6 shadow-2xl mb-6 flex flex-col items-center justify-center text-center">
        ...
        <button
          ...
          className="bg-red-500/20 text-red-400 border border-red-500/30 px-4 py-2 rounded-xl text-sm font-medium hover:bg-red-500/30 transition"
        >
          Retry Generation
        </button>
      </div>
    ...
    return (
      <div className="w-full bg-white/[0.035] backdrop-blur-xl border border-white/[0.10] rounded-2xl p-6 shadow-2xl mb-6 flex flex-col items-center justify-center text-center">
        ...
        <p className="text-xs text-gray-400">
          Complete your AI Health Profile settings to get personalized alerts.
        </p>
      </div>
    );
  }
      ...
      <div className="flex justify-between items-start mb-4">
        ...
        <span
          className={cn(
            ...
            riskColors[report.riskLevel] || riskColors['Moderate']
          )}
        >
